...
Run validation tests to ensure the application works correctly. Automatically detects project type and runs appropriate tests. Use this after `/EA-build` to verify your implementation.
